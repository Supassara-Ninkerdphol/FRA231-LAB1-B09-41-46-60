###########################################################################
## Makefile generated for component 'encoder'. 
## 
## Makefile     : encoder.mk
## Generated on : Wed Oct 30 18:43:34 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/encoder.elf
...
COMPILER_COMMAND_FILE     = encoder_comp.rsp
CMD_FILE                  = encoder.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/encoder.elf
...
DEFINES_ = -DMW_TIM3_ENABLED=1 -DMW_TIM3_ENCODER_VAR=mw_tim3 -DMW_TIM1_ENABLED=1 -DMW_TIM1_ENCODER_VAR=mw_tim1 -DMW_TIM8_ENABLED=1 -DMW_TIM8_ENCODER_VAR=mw_tim8 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DUSE_FULL_LL_DRIVER -DSTM32G474xx -DUSE_HAL_DRIVER -DMW_TIMEBASESOURCE=TIM2 -DMW_CONNECTIVITY_UART=LPUART1_BASE -DMW_CONNECTIVITY_RX_DMA=DMA1 -DMW_LPUART1_RX_DMA_STREAM=1 -DMW_LPUART1_RX_DMA_ENABLED=DMA1_Channel1_IRQHandler -DMW_CONNECTIVITY_RX_DMAStream=LL_DMA_CHANNEL_1 -DMW_CONNECTIVITY_RX_BUFFER=GET_LPUART1_RECEIVE_BUFFER -DMW_LPUART1_RECEIVE_BUFFER_SIZE=1024 -DMW_LPUART1_ENABLED=1
...
DEFINES_STANDARD = -DMODEL=encoder -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"C:\RMX\labencoder\encoder\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"C:\RMX\labencoder\encoder\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"C:\RMX\labencoder\encoder\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"C:\RMX\labencoder\encoder\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
%.o : $(START_DIR)/encoder_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/encoder_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/encoder_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/encoder_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/encoder_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
encoder.o : $(START_DIR)/encoder_ert_rtw/encoder.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/encoder_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
